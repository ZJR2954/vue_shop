            ...
            <el-table :data="userlist" border stripe>
                ...
                <el-table-column label="状态" prop="mg_state">
                    <template v-slot="scope">
                        <el-switch v-model="scope.row.mg_state" @change="userStateChanger(scope.row)">
                        </el-switch>
                    </template>
                </el-table-column>
        ...
        methods: {
            ...
            addUser() {
                ...
                this.$refs.addFormRef.validate(valid => {
                    ...
                    const {data: ref} = {data: {data: {}, meta: {msg: "添加用户成功", status: 201}}};
            ...
            async removeUserById(id) {
                ...
                //如果用户确认删除则返回文本'confirm'
                //如果用户取消删除则返回文本'cancel'
