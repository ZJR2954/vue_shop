...
<script>
    ...
    export default {
        ...
        methods: {
            //获取所有商品分类列表
            getCateList() {
                // const {data: res} = await this.$http.get('catgories');
                const {data: res} = {
                    data: {
                        data:
                            {
            ...
            add() {
                ...
                this.addForm2 = this.addForm;
                this.addForm2.goods_cat = this.addForm.goods_cat.join(',');

                // const {data: res} = await this.$http.post('goods', this.addForm2);
